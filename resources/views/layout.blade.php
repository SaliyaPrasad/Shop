...
<head>
    ...
    <title>Home | World-Shopper</title>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{URL::to('frontend/ifrontend/mages/ico/apple-touch-icon-72-precomposed.png')}}">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item active">
											...
											<?php } ?>
								<div class="col-sm-4">
									<h1><span>WORLD</span>-SHOPPER</h1>
									<h2>Best shopping Site</h2>
